...
<body>
    ...
    SELECT kalender.trainDate, wod.wodId, wod.wodName, wod.difficulty, kalender.comment
    FROM `kalender`
            ...
            <table class="table">
                <thead class="thead-dark" style="position: sticky;top: 0">
                    <tr>
                        ...
                        <th class="header" scope="col">Bemerkungen</th>
                ...
                while ($row = mysqli_fetch_assoc($res2)) {
                    ...
                    echo "<td class='table-admin'>" . $row['trainDate'] . " </td>";
                    echo "<td class='table-admin'>" . $row['wodId'] . "</td>";
                    echo "<td class='table-admin'>" . $row['wodName'] . "</td>";
                    echo "<td class='table-admin'>" . $row['difficulty'] . "</td>";
