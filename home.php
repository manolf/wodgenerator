...
<body>
    ...
    <hr>
    <h3 class="text-success">Neues Training</h3>
    ...
    <form action="wod.php" method='post'>
        ...
        <div class="form-group">
            ...
            <div class="container-equipment">
                ...
                <select name='equipment' style="width:90%;">
                ...
                <input class="form-control btn btn-outline-success mt-4" type="submit" name="submit" value="ich hols mir" />
                <!-- 
