...
<body>
    ...
    <div class="container-team">
        ...
        <div class="col-lg-6 col-md-12 mb-5 d-md-flex justify-content-around">
            ...
            <div class="avatar mb-md-0 mb-4 mx-4">
                <br><br>
                <img src="./images/orsi_elf.png" class="rounded z-depth-1" alt="pic orsi" style="width:350px;height:350px" target="_blank">
            </div>
            <div class="mx-4">
                <h4 class="header-foto font-weight-bold mb-3">GRAPHICS AND ILLUSTRATIONS</h4>

                <h6 class="font-weight-bold grey-text mb-3">orsolya veres</h6>
                <!-- <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod eos id officiis hic
                    tenetur.</p> -->
